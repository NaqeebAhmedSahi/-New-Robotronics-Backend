...
import { getAllUsers, deleteUser, getAllCourses, deleteCourse } from "../Controller/adminController.js"; // Correct named import
import { protectC, isAdmin } from "../middleware/courseMiddleware.js"; // Assuming you have these middlewares
